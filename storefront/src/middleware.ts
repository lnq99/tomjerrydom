...
// Fetch regions from Medusa. We can't use the JS client here because middleware
// runs on the Edge runtime (no Node.js). Caching is handled by fetch's
// force-cache + revalidate — NOT by a module-level Map, which would be
// re-initialised on every Cloudflare Worker isolate.
